...
<head>
    ...
    <title>专题5 N-step-CSCAN 磁盘算法</title>
</head>
...
<body>
    ...
    <div class="main shadow p-5 rounded">
        ...
        <p>[1]. (5分)采用<strong>N-step-CSCAN（N=
                <input type="text" class="Nstep form-control textinput span-input">
                ）</strong>磁盘调度算法时，写出磁道访问序列；</p>
